      ...
      if (params.collection) {
        try {
          let responce = await axios.get(
            `https://dummyjson.com/products/category/${params.collection}`,
          );
        ...
        <div className="py-10 ">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div className="1/4 bg-red-950 text-white px-4 py-4 rounded-2xl">
              <select>
                <option className="bg-red-950 text-white w-full my-3">
                  Default
                </option>
                <option className="bg-red-950 text-white w-full my-3" value="">
                  A to Z
                </option>
                <option className="bg-red-950 text-white w-full my-3" value="">
                  Z to A
