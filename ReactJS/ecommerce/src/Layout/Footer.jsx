        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2 pr-0 lg:pr-10">
            ...
            <div className="flex items-center gap-x-4 mb-4">
              <img src="https://png.pngtree.com/png-clipart/20240621/original/pngtree-symbolic-significance-smart-logo-solutions-for-contributor-desig-png-image_15379534.png" alt="logo" className="w-10 object-cover" />
