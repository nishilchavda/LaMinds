import { CircleCheck, Focus, Search } from "lucide-react";
      ...
      <section className="flex items-end justify-center w-full">
        ...
        <div className="w-1/2 overflow-hidden px-6">
          ...
          <p className="my-2 text-[18px] font-normal">
            ...
            <div className="bg-gray-200 px-4 py-3 flex items-center justify-between gap-x-2 rounded-full w-full">
        ...
        {/* card */}
        <div className="w-1/2 border border-[#0000001f] rounded-lg px-4 py-6 flex items-center justify-evenly max-w-xl">
          {/* text and btn */}
          <div className="w-1/2 flex justify-end items-start gap-y-25 flex-col">
            ...
            <div>
              ...
              <p className="text-[15px] font-semi-bold text-[#767676] leading-normal my-2">
                Premium downloads
                <br />
          ...
          <div className="w-1/2 relative">
            ...
            {/* chip 1 */}
            <div className="flex items-center justify-center gap-x-1 absolute z-10 top-32 left-18 border-gray-200 rounded-full px-2 py-1 bg-white text-[12px]">
              <CircleCheck fill="green" className="text-white w-5 h-5" />
              Worry-free Licensing
            </div>

            {/* chip 2 */}
            <div className="flex items-center justify-center gap-x-1 absolute z-10 text-[12px] bg-white border border-gray-200 rounded-full px-2 py-1 top-44 -left-6">
              <CircleCheck fill="green" className="text-white w-5 h-5" />
              Cleared for all users
            </div>
